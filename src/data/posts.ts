...
export const posts: Post[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "A maior resistência está nos primeiros dois minutos. Se a tarefa começa com algo trivial, o corpo entra em movimento e a mente acompanha. O objetivo do dia ruim não é performar, é não quebrar a sequência.",
  ...
  },
  {
    ...
    description:
      "Ideias não faltam. Falta um caminho entre a inspiração e a execução. Entenda as três falhas mais comuns e como corrigi-las.",
    date: "2026-07-19",
    readingTime: "6 min",
    category: "Execução",
    content: [
      ...
      "Executar é uma habilidade treinável. Ela começa quando você trata a ideia como um projeto pequeno, e não como um sonho grande.",
    ],
  },
  {
